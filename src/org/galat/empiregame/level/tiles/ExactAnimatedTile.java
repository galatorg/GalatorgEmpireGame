...
public class ExactAnimatedTile extends ExactTile
{
	...
	public ExactAnimatedTile(int id, int[][] animationCoords, int levelColor, int animationSwitchDelay, SpriteSheet sheet)
	{
		super(id, animationCoords[0][0], animationCoords[0][1], levelColor, sheet);
